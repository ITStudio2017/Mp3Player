...
//    private JPanel imagePanel;
    public String url;
    public ImageIcon backgroundimg = new ImageIcon(System.getProperty("user.dir") +"/"+url);
    public int width;
    public int height;
    public JPanel getJPanelBackground(JPanel imagePanel){
...
//
            backgroundimg = new ImageIcon(System.getProperty("user.dir") +"/"+url);
            Image img = backgroundimg.getImage();
            g.drawImage(img, 0, 0, width,
                    height,
                    backgroundimg.getImageObserver());
//            imag.setPreferredSize(new Dimension(backgroundimg.getIconWidth(),
